...
export default function RegulaminPageView() {
    return (
        <MarketingArticleShell title="Regulamin">
            ...
            <h2>2. Definicje</h2>
            <p>
                <strong>Sklep</strong> - sklep internetowy dostępny pod adresem fryzjerpremium.pl
                <br />
            ...
            <h2>3. Zamówienia</h2>
            <p>
                Składając zamówienie, Klient akceptuje wszystkie warunki określone w niniejszym
                regulaminie oraz potwierdza, że zapoznał się z informacjami o produkcie.
            </p>
            <h2>4. Płatności</h2>
            <p>
