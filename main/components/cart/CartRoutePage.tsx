...
export default function CartRoutePage() {
    ...
    if (authStatus === "need_email") {
        return (
            <StorefrontShell openLoginModal={openLoginModal}>
                <div className="min-h-screen pt-[120px] pb-16 px-4 flex items-center justify-center">
                    <div className="max-w-md w-full rounded-xl border border-[rgba(212,196,176,0.3)] bg-white/60 p-8">
                        <h1 className="text-xl font-bold text-gray-900 mb-2">Podaj adres e-mail</h1>
                        <p className="text-gray-600 text-sm mb-6">
                            Aby kontynuować zakupy jako gość, podaj adres email, na który ma przyjść
                            potwierdzenie zakupu.
                            <br />
                            Aby kontynuować zakupy jako zarejestrowany użytkownik,{" "}
                            <Link href="/login" className="text-[#D2B79B] hover:text-[#b89a7f]">
                                zaloguj się
                            </Link>
                            , albo{" "}
                            <Link href="/rejestracja" className="text-[#D2B79B] hover:text-[#b89a7f]">
                                zarejestruj się
                            </Link>
                            .
                        </p>
                            ...
                            {userExists && (
                                <p className="mt-2 text-red-500 text-sm">
                                    ...
                                    <Link
                                        ...
                                        className="text-[#D2B79B] hover:text-[#b89a7f]">
                                        zaloguj się
                                    </Link>
                                </p>
                            )}
                        ...
                        <p className="mt-4 text-xs text-gray-500">
                            Kliknięcie „Wstecz” bez podania adresu e-mail przekieruje na stronę główną z
                            informacją o wymaganym podaniu adresu e-mail.
                        </p>
                    </div>
                </div>
            </StorefrontShell>
