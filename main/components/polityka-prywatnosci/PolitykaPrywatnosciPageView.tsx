...
export default function PolitykaPrywatnosciPageView() {
    return (
        <MarketingArticleShell title="Polityka prywatności">
            <h2>1. Administratorem danych osobowych</h2>
            <p>
                Administratorem danych osobowych jest Antoine Hair Institute z siedzibą w Polsce.
                Wszelkie dane osobowe przetwarzane są zgodnie z obowiązującymi przepisami prawa, w
                szczególności z Rozporządzeniem RODO.
            </p>
            ...
            <p>
                Dane osobowe są przetwarzane w celu realizacji zamówień, obsługi klienta, marketingu (za
                zgodą) oraz wypełnienia obowiązków prawnych.
            </p>
