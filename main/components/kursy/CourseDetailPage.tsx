...
import CourseReviewTabs from "./CourseReviewTabs";
import { Clock, Users, Award, Globe, CheckCircle, PlayCircle, ShoppingCart, Info, MapPin, CalendarClock, Calendar } from "lucide-react";
...
export default function CourseDetailPage({ courseSlug }: CourseDetailPageProps) {
    ...
    const formatDataRozpoczecia = (): string => {
        ...
        const s = formatLocaleDateTime(
            typeof course.data_rozpoczecia === "string"
                ? course.data_rozpoczecia
                : course.data_rozpoczecia,
        );
        return s === "—" ? "" : s;
